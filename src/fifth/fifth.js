...
import "./fifth.css";
import bg from "../assets/bg-five.png";
              ...
              >
                <div class="text-title-spacing">
                  ...
                  <div class="introduction-info-en-title">
                    ...
                    <span class="text-red-title">FREE</span>!{" "}
                  </div>
                </div>
                <div> Six years ago, </div>
                <div>
                  {" "}
                  on April Fool's Day by chance, we determined to develop a
                  big-deal video game.{" "}
                </div>
                <div>
                  {" "}
                  Another six years before that, we fiercely argued about where
                  Sun WuKong headed to{" "}
                </div>
                <div> after his Buddhahood. </div>
                <div class="text-leading">
                  {" "}
                  Twelve years in total, the commitment we made became malarky
                  in the end.{" "}
                </div>
                <div>
                  {" "}
                  On countless nights of working overtime, exhaustedly, we asked
                  ourselves half-jokingly --{" "}
                </div>
                <div>
                  {" "}
                  how much did it matter whether{" "}
                  <span class="text-red">Game Science </span>exist or not?{" "}
                </div>
                <div>
                  {" "}
                  Had any game we developed provided this world with more fun?{" "}
                </div>
                <div>
                  {" "}
                  Had any story, character or gameplay we made ever inspired
                  you, players?{" "}
                </div>
                <div class="text-leading">
                  {" "}
                  I have to confess, we ourselves know the answer neither.{" "}
                </div>
                <div>
                  {" "}
                  However, we have faith in the new product, which arouses our
                  own feeling firstly,{" "}
                </div>
                <div>
                  {" "}
                  could also touch people who share the same thoughts.{" "}
                </div>
                <div>
                  <span>Black Myth: WuKong</span>, an{" "}
                  <span class="text-red">action-adventure game </span>themed
                  around legendary Chinese novel{" "}
                </div>
                <div class="text-leading">
                  <span class="text-exclusive">Journey to the West</span>, is
                  the newest answer given by Game Science.{" "}
                </div>
                <div></div>
